...
begin
  ...
  #244:begin
         ...
         then begin
                ...
                statusbar1.Panels[0].Text:='Съедено '+inttostr(tar);
              end;
       end;
  ...
  statusbar1.Panels[1].Text:='Вы нахадитесь на ('+inttostr(mx)+'; '+inttostr(my)+')';
  for i:=1 to 40 do
  if target[i].visible
...
begin
  if mainmenu1.Items[1].Caption='Пауза' then begin
  packt.Enabled:=false;
  enemyt.Enabled:=false;
  mainmenu1.Items[1].Caption:='Продолжить';
  end
  else begin
         packt.Enabled:=true;
         enemyt.Enabled:=true;
         mainmenu1.Items[1].Caption:='Пауза';
       end;
end;
