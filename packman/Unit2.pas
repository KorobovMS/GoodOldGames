...
begin
  label1.Caption:='Скорость Пакмана= '+inttostr(pspeed.Position);
end;

procedure TForm2.espeedChange(Sender: TObject);
begin
  label2.Caption:='Скорость врагов= '+inttostr(espeed.Position);
end;
...
begin
  ...
  if upack.Form1.MainMenu1.Items[1].Caption='Продолжить'
  then upack.Form1.MainMenu1.Items[1].Caption:='Пауза';
end;
